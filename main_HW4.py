...
# 4 Создать список из 10 элементов, вставить на 3-ю
# позицию новое значение, удалить 6-тое
var_list10 = [1, 2, 3, 15, 56, 31, 7, 8, 2344556, 1]
print(correct_list_ten_elem(var_list10, 2, 1000, 5))
...
print("\nУсловия:")
# 1 Дано целое число, если оно положительное, то
# прибавить к нему 1, или не изменять
print(pos_plus(68))
...
# 2 Поле с двумя сортами цветов S1 и S2... через
# сколько лет S1 цветов будет меньше 10% от S2
print(sq_flow(100, 3))
