...
# 1 Связать переменную с любой строкой, состоящей не менее чем из 8 символов...
...
var_str15_3 = var_str15[0:2] + var_str15[3:5] + var_str15[6:8]  + var_str15[9:11] + var_str15[
                                                                                   12:14]  # удаляем индексы кратные 3
...
# 3 Есть строка: “my name is name”. Напечатать ее, но вместо 2ого “name” вставить имя
...
test_tring_w = test_tring.find("w") #на каком месте находится буква w
test_tring_l = test_tring.count("l") #кол-во букв l
test_tring_start = test_tring.startswith("Hello") #начинается ли строка с подстроки: “Hello
test_tring_end = test_tring.endswith("qwe") #заканчивается ли строка подстрокой: “qwe"
