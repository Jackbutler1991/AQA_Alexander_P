...
# Добро пожаловать в {var_str_city} {var_str_country}")
...
# вставить на 3-ю позицию новое значение, удалить 6-тое
def correct_list_ten_elem(var_list, var_index_change, var_change, var_del):
